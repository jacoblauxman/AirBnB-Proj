...
router.get('/', async (req, res) => {
  ...
  if (Object.keys(req.query).length) {
    ...
    console.log('PAGLIM', pagination.limit)
    console.log('PAGOFF', pagination.offset)
    ...
    const allSpots = await Spot.findAll({
      ...
      // ^^keeps pagination from breaking^^
      include: [
        {
          model: Review,
          attributes: []
      ...
      // can't use spread on pagination with subquery info
      // where,
