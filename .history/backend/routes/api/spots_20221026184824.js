...
router.get('/', async (req, res) => {
  ...
  if (Object.keys(req.query).length) {
    ...
    let allSpotsAndQueries = []
    // }
    for (let spot of allSpots) {
      spot = spot.toJSON()
      spot.limit = pagination.limit
      spot.offset = pagination.offset
      allSpotsAndQueries.push(spot);
    }
    console.log(allSpotsAndQueries)
    res.json({ Spots: allSpotsAndQueries, page, size })
  } else {
